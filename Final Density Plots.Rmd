...
grass<-read.csv("Final Code and Plots/Data/WeFixedItAnalyzeMe.csv")
#fish family information
fish<-read.csv("Final Code and Plots/Data/AllMerged.csv")
...
library(patchwork)
#import csv
AllMerged<- read_csv("Final Code and Plots/Data/AllMerged.csv")
