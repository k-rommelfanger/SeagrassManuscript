...
Lab<-plotframe%>%
  ...
  scale_x_discrete(labels = NULL)+
  geom_text(aes(family="serif", fontface="plain"),x= "deep" , y=0.2, label="a")+#add first letter, family and fontface change font and remove bold
...
Lut<-plotframe%>%
  ...
  scale_x_discrete(labels = NULL)+#add first letter, family and fontface change font and remove bold+
  geom_text(aes(family="serif", fontface="plain"),x= "deep" , y=0.37, label="a")+
...
Ser<-plotframe%>%
  ...
  scale_x_discrete(labels = NULL)+
  geom_text(aes(family="serif", fontface="plain"),x= "deep" , y=0.19, label="a")+#add first letter, family and fontface change font and remove bold
...
Pom<-plotframe%>%
  ...
  theme(plot.title = element_text(hjust = 0.5), legend.position = "bottom")+#how to center the title
  scale_fill_manual(
  name = "Category",
  values = c("deep" = "#56B4E9", "hal" = "#F0E442", "native" = "#CC79A7"),
  labels = c(
...
Mon<-plotframe%>%
  ...
  theme(plot.title = element_text(hjust = 0.5), legend.position = "none")+#how to center the title
 scale_fill_manual(
  name = "Category",
  values = c("deep" = "#56B4E9", "hal" = "#F0E442", "native" = "#CC79A7"),
  labels = c(
...
#add the theme to set font to size 12
Lab<-Lab + theme( text = element_text(size = 12),          # minimum readable font
...
Lut<-Lut+ theme( text = element_text(size = 12),          # minimum readable font
  axis.text = element_text(size = 12),
  axis.title = element_text(size = 12),
  plot.title = element_text(size = 12),
  legend.text = element_text(size = 12)
...
Gob<-Gob+ theme( text = element_text(size = 12),          # minimum readable font
  axis.text = element_text(size = 12),
  axis.title = element_text(size = 12),
  plot.title = element_text(size = 12),
  legend.text = element_text(size = 12)
)
  Ser<-Ser+ theme( text = element_text(size = 12),          # minimum readable font
  axis.text = element_text(size = 12),
  axis.title = element_text(size = 12),
  plot.title = element_text(size = 12),
  legend.text = element_text(size = 12)
)
  Scar<-Scar+ theme( text = element_text(size = 12),          # minimum readable font
  axis.text = element_text(size = 12),
  axis.title = element_text(size = 12),
  plot.title = element_text(size = 12),
  legend.text = element_text(size = 12)
  ...
  Labm<-Labm+ theme( text = element_text(size = 12),          # minimum readable font
  axis.text = element_text(size = 12),
  axis.title = element_text(size = 12),
  plot.title = element_text(size = 12),
  legend.text = element_text(size = 12)
  ...
  Labm
   ...
   Car<-Car+ theme( text = element_text(size = 12),          # minimum readable font
  axis.text = element_text(size = 12),
  axis.title = element_text(size = 12),
  plot.title = element_text(size = 12),
  legend.text = element_text(size = 12)
,axis.text.x = element_text(angle = 35, hjust = 1))
   ...
   Pom<-Pom+ theme( text = element_text(size = 12),          # minimum readable font
  axis.text = element_text(size = 12),
  axis.title = element_text(size = 12),
  plot.title = element_text(size = 12),
  legend.text = element_text(size = 12)
,axis.text.x = element_text(angle = 35, hjust = 1))
  Mon<-Mon+ theme( text = element_text(size = 12),          # minimum readable font
  axis.text = element_text(size = 12),
  axis.title = element_text(size = 12),
  plot.title = element_text(size = 12),
  legend.text = element_text(size = 12)
...
DifferentScales
#and now export using ggsave



ggsave(filename = "DensityPlot.png", plot = DifferentScales, width = 10, height = 7, units = "in",bg="white", dpi = 300)
