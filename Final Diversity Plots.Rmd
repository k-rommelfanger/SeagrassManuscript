...
RichnessFinal<-finaldiversityplots%>%
  ...
  theme(legend.position="none",panel.background = element_rect(fill = "white", colour = "grey50"),plot.title = element_text(hjust = 0.5),axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))+#no legend, gridlines or grey background, centered title
   theme(
  text = element_text(size = 10),          # All text
...
SimpsonsFinal<-finaldiversityplots%>%
  ...
  theme(legend.position="none",panel.background = element_rect(fill = "white", colour = "grey50"),plot.title = element_text(hjust = 0.5),axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))+#no gridlines or grey background, centered title
   theme(
  text = element_text(size = 10),          # All text
  axis.text = element_text(size = 10),     # Axis ticks
  axis.title = element_text(size = 10),    # Axis labels
...
ggsave("DiversityPlot.png", DiversityPlot, width = 8, height = 5, dpi = 300)
```
