...
legend.position = "bottom")+ 
  geom_text(data = fam, aes(x = MDS1, y = MDS2, label = sp), alpha = 1)+scale_fill_manual(name = "Category", labels = c("> 15m", "100% Halophila < 15m","Native Present and < 15m"),values = c("#56B4E9","#F0E442","#CC79A7"))+scale_color_manual(name = "Category", labels = c("> 15m", "100% Halophila < 15m","Native Present and < 15m"), values = c("#56B4E9","#F0E442","#CC79A7"))+annotate(geom="text", x=1.5, y=1.2, label="stress=0.234")
